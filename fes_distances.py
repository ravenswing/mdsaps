    ...
    for system in SYSTS:
        for lig in LIGS:
            ...
            for rep in REPS:
                ...
                portal_traj = traj_aligned.atom_slice(portal_atoms)
                ligand_traj = traj_aligned.atom_slice(ligand_atoms)

                # Compute coordinates of both centers of mass
                portal_crds = md.compute_center_of_mass(portal_traj)
                ligand_crds = md.compute_center_of_mass(ligand_traj)

                # Load coordinates into pd DataFrame
